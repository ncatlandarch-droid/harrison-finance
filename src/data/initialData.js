...
export const INITIAL_DATA = {
  ...
  accounts: [
    ...
    { id: "chris_nc_tsers", name: "TSERS Lifetime State Pension (Member #1875708)", type: "Pension", memberId: "chris", institution: "NC Retirement Systems (ORBIT)", balance: 3117.50, status: "Vested - $3,117.50/mo Lifetime", monthlyBenefit: 3117.50, beneficiary: "Erin Harrison", contributionRate: "6.0%", email: "wcharris@ncat.edu" },
